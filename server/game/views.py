...
def AI(request) :
  ...
  print(os.getcwd())
  print(os.listdir())
  input_text = os.popen('python ./bin/inference.py --model_path "/usr/src/app/kospeech_latest/outputs/train_model/10-37-48/model.pt" --audio_path "/usr/src/app/wave_file/sample.wav" --device "cpu"')
